...
<head>
    ...
    <style>
        .rightValidate { width: 280px; margin: 0px auto; position: relative; line-height: 40px; height: 30px;
            text-align: center; z-index: 99; margin-top:60px;}
        .v_rightBtn { position: absolute; left: 0; top: 0; height: 40px; width: 50px; background: #ffffff; cursor:
                pointer; box-shadow: 0 0 3px rgba(0, 0, 0, 0.3);border-radius: 2px; }
        ...
        .hkinnerWrap{ border: 1px solid #eee; z-index:9999; background-color: #F7F9FA}
        .green{ border-color:#03b703 !important; }
        .green .v_rightBtn{ background: #03b703;}
        .green .v_rightBtn .notSel{color: #fff; }
        ...
        .v_rightBtn .notSel{ user-select: none; -webkit-user-select: none; -moz-user-select: none;
            -ms-user-select:
                none;
...
<div class="comImageValidate rightValidate">
    ...
    <div class="hkinnerWrap" style="height:40px; position: relative">
        <span class="v_rightBtn "><span class="notSel">> ></span></span>
